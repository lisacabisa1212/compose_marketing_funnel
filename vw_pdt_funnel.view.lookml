...
# # Or, you could make this view a derived table, like this:
  derived_table:
    sql: |
      ...
      -- Traffic
      select distinct to_date(substr(cast(gau.year_month as text),1,4) || '-' || substr(cast(gau.year_month as text),5), 'YYYY-MM-DD') as Month, 'Step 1 - Website Traffic (visitors)' as Funnel, sum(gau.users) as Users
      ...
      and a.billing_method <> 'comped' -- accounts which are not comped
